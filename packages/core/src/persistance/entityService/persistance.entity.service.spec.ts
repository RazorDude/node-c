...
import { DeleteOptions, FindOneOptions, FindOptions, UpdateOptions } from './persistance.entity.service.definitions';
...
describe('PersistanceEntityService Base Class', () => {
  ...
  describe('count', () => {
    it('should throw an ApplicationError with "count" in the message', async () => {
      const dummyOptions: FindOptions = {} as FindOptions;
  ...
  describe('delete', () => {
    it('should throw an ApplicationError with "delete" in the message', () => {
      const dummyOptions: DeleteOptions = {} as DeleteOptions;
  ...
  describe('findOne', () => {
    it('should throw an ApplicationError with "findOne" in the message', () => {
      const dummyOptions: FindOneOptions = {} as FindOneOptions;
  ...
  describe('update', () => {
    it('should throw an ApplicationError with "update" in the message', async () => {
      ...
      const dummyOptions: UpdateOptions = {} as UpdateOptions;
...
describe('DummyPersistanceEntityService Subclass', () => {
  ...
  it('count should throw an error with "count" in the message', async () => {
    await expect(service.count({} as FindOptions)).rejects.toThrow(/count/);
  });
  it('delete should throw an error with "delete" in the message', () => {
    expect(() => service.delete({} as DeleteOptions)).toThrow(/delete/);
  });
  it('find should throw an error with "find" in the message', () => {
    expect(() => service.find({} as FindOptions)).toThrow(/find/);
  });
  it('findOne should throw an error with "findOne" in the message', () => {
    expect(() => service.findOne({} as FindOneOptions)).toThrow(/findOne/);
  });
  it('update should throw an error with "update" in the message', async () => {
    await expect(service.update({ id: 12, value: 'dummy' }, {} as UpdateOptions)).rejects.toThrow(/update/);
  });
});
